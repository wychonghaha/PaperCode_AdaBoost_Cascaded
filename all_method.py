...
from othermodels_all import all_model
...
for i in datasets:
    ...
    if mode=='train':
        ...
        print(str(total),'Our_cnn:',s1[1],'Rotation Forest:',d[0],'Adaboost RF:',d[1],'RF：',d[2],'Bagging RF:',d[3],'Bagging Rof:',d[4],'Adaboost RF:',d[5])
