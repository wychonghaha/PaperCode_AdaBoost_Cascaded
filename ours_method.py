...
for i in datasets:
    ...
    #our_net
    model_path='model_88/deep_model_'+part_or_all+str(total)+'.h5'#+'_'+str(num_classes) +'_'+suiji_or_chazhi
    ...
    if mode=='train':
        ...
        plt.legend()
        # plt.show()
        plt.savefig('./logs/'+str(total)+'.png')
        ...
        print(str(total)+' samples/one_category test_acc:','A_convNet:',s2[1],'Our_cnn:',s1[1],'Rotation Forest:',d[0],'Adaboost RF:',d[1])
